if __name__ == '__main__':
    ...
    def whoStart(player, computer):
        player_koz = [VERTE_SK[i.rank] for i in player if i.suite == kozer.suite]
        computer_koz = [VERTE_SK[j.rank] for j in computer if j.suite == kozer.suite]
